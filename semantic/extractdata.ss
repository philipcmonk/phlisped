...
(display-on-screen 0 30 (round (/ WIDTH 2)) (- HEIGHT 30) (triple-start (car (graph-edges G))) (compose (curry map triple-end) (curryr (curry graph-neighborhood-edge-forward G) "has child")))
