...
(struct other2-v11n-utterance utterance (total-height runtime-vals))
                                   ...
                                   (let ((res (node->utterance
                                    ...
                                    (if (null? res)
                                     (list
                                      ...
                                      (cadr data))
                                     (list
                                      (+ (car data) (other2-v11n-utterance-total-height res))
                                      (append
                                       (cadr data)
                                       (list res))))))
                                  (list (+ y (node-height n tree)) '())
                                  (node-args n))))))
                         (other2-v11n-utterance
                          n
                          x
                          y
...
;                          (foldl + (node-height n tree) (map utterance-h children))
                          ...
                          children
                          (get-color n tree)
                          (foldl + (node-height n tree) (map other2-v11n-utterance-total-height children))
                       ...
                       (let find-utterance ((root root) (x x) (y y))
                        (with
                         ((if (or
                               ...
                               (> y (+ (utterance-y root) (other2-v11n-utterance-total-height root))))
                           root
                           (ormap
                            (lambda (child)
                             (if (< y (+ (utterance-y child) (other2-v11n-utterance-total-height child)))
